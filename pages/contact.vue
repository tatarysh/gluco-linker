<template>
  <v-container>
    <v-row justify="center">
      <v-col cols="12" md="6">
        <v-card elevation="2">
          <v-card-title class="text-h5">{{ $t('contact:title') }}</v-card-title>
          <v-card-text>
...
useSeoMeta({
  title: computed(() => `${i18n.t('contact:title')} - ${i18n.t('app.name')}`),
  description: computed(() => i18n.t('contact:description')),
})
</script>
